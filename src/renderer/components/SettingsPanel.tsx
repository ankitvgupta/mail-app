          ...
          <div className="max-w-3xl space-y-6">
            <div>
              ...
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-600 mb-6 space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={appearance.vibrancy}
                        onChange={(e) => updateAppearance({ vibrancy: e.target.checked })}
                ...
                {/* Font size */}
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Font Size</h3>
                  <div className="flex space-x-2">
                    {(["small", "default", "large"] as const).map((size) => (
                      <button
                        key={size}
                        onClick={() => updateAppearance({ fontScale: size })}
                        className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors capitalize ${
                          appearance.fontScale === size
                            ? "bg-blue-600 dark:bg-blue-500 text-white"
                            : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                        }`}
                      >
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    {(["narrow", "default", "wide"] as const).map((w) => (
                      <button
                        key={w}
                        onClick={() => updateAppearance({ sidebarWidth: w })}
                        className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors capitalize ${
                          appearance.sidebarWidth === w
                            ? "bg-blue-600 dark:bg-blue-500 text-white"
                            : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                        }`}
                      >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    Adjusts spacing in email content.
                  </p>
                  <div className="flex space-x-2">
                    {(["compact", "default", "relaxed"] as const).map((ls) => (
                      <button
                        key={ls}
                        onClick={() => updateAppearance({ lineSpacing: ls })}
                        className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors capitalize ${
                          appearance.lineSpacing === ls
                            ? "bg-blue-600 dark:bg-blue-500 text-white"
                            : "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
                        }`}
                      >
